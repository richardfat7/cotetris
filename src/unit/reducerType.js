...
export const PEER_SAVE_TEAM_INFO = 'PEER_SAVE_TEAM_INFO';
export const PEER_SAVE_CONNECTION_LOOKUP = 'PEER_SAVE_CONNECTION_LOOKUP';
...
// Lobby
export const ADD_LOBBY_MEMBER = 'ADD_LOBBY_MEMBER';
export const REMOVE_LOBBY_MEMBER = 'ADD_LOBBY_MEMBER';
