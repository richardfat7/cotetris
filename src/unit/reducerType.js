...
// Peerjs
export const PEER_SAVE_MY_ID = 'PEER_SAVE_MY_ID';
export const PEER_SAVE_LEADER_ID = 'PEER_SAVE_LEADER_ID';
export const PEER_SAVE_TEAMMATE_ID = 'PEER_SAVE_TEAMMATE_ID';
export const PEER_SAVE_OPPONENT_LEADER_ID = 'PEER_SAVE_OPPONENT_LEADER_ID';
export const PEER_SAVE_OPPONENT_TEAMMATE_ID = 'PEER_SAVE_OPPONENT_TEAMMATE_ID';
...
export const LINES_RECEIVED = 'LINES_RECEIVED';
